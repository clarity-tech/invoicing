...
* @route '/teams/{team}/members'
*/
const storeForm = (args: { team: string | number } | [team: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/teams/{team}/members'
*/
storeForm.post = (args: { team: string | number } | [team: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: store.url(args, options),
    method: 'post',
})
...
* @route '/teams/{team}/members/{user}'
*/
const updateForm = (args: { team: string | number, user: string | number } | [team: string | number, user: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/teams/{team}/members/{user}'
*/
updateForm.put = (args: { team: string | number, user: string | number } | [team: string | number, user: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/teams/{team}/members/{user}'
*/
const destroyForm = (args: { team: string | number, user: string | number } | [team: string | number, user: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/teams/{team}/members/{user}'
*/
destroyForm.delete = (args: { team: string | number, user: string | number } | [team: string | number, user: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroy.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
