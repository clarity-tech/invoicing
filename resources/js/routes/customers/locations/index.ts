...
* @route '/customers/{customer}/locations/{location}'
*/
const updateForm = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/customers/{customer}/locations/{location}'
*/
updateForm.put = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/customers/{customer}/locations/{location}'
*/
const destroyForm = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/customers/{customer}/locations/{location}'
*/
destroyForm.delete = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroy.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
