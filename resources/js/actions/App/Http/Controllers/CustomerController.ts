...
* @route '/customers/{customer}/locations'
*/
const storeLocationForm = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/customers/{customer}/locations'
*/
storeLocationForm.post = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: storeLocation.url(args, options),
    method: 'post',
})
...
* @route '/customers/{customer}/locations/{location}'
*/
const updateLocationForm = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/customers/{customer}/locations/{location}'
*/
updateLocationForm.put = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateLocation.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/customers/{customer}/locations/{location}'
*/
const destroyLocationForm = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/customers/{customer}/locations/{location}'
*/
destroyLocationForm.delete = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroyLocation.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/customers/{customer}/primary-location/{location}'
*/
const setPrimaryLocationForm = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: setPrimaryLocation.url(args, options),
    method: 'post',
})
...
* @route '/customers/{customer}/primary-location/{location}'
*/
setPrimaryLocationForm.post = (args: { customer: number | { id: number }, location: number | { id: number } } | [customer: number | { id: number }, location: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: setPrimaryLocation.url(args, options),
    method: 'post',
})

setPrimaryLocation.form = setPrimaryLocationForm
