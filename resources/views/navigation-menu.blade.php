<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('numbering-series.index') }}" :active="request()->routeIs('numbering-series.*')">
                        {{ __('Numbering Series') }}
                    </x-nav-link>
                </div>
            </div>
                        ...
                        <x-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    @if(Auth::user()->currentTeam && !Auth::user()->currentTeam->personal_team && Auth::user()->currentTeam->needsSetup())
                                        <!-- Setup Warning -->
                                        <div class="block px-4 py-2 bg-yellow-50 border-b border-yellow-200">
                                        ...
                                        <x-dropdown-link href="{{ route('organization.setup') }}" class="text-yellow-700 bg-yellow-50">
                                            <div class="flex items-center">
                                                ...
                                                Complete Setup ({{ Auth::user()->currentTeam->getSetupCompletionPercentage() }}%)
                                            </div>
                                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('numbering-series.index') }}" :active="request()->routeIs('numbering-series.*')">
                {{ __('Numbering Series') }}
            </x-responsive-nav-link>
        </div>
