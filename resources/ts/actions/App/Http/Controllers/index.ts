...
const Controllers = {
    TermsOfServiceController: Object.assign(
        TermsOfServiceController,
        TermsOfServiceController,
    ),
    PrivacyPolicyController: Object.assign(
        PrivacyPolicyController,
        PrivacyPolicyController,
    ),
    PublicViewController: Object.assign(
        PublicViewController,
        PublicViewController,
    ),
    UserProfileController: Object.assign(
        UserProfileController,
        UserProfileController,
    ),
    OtherBrowserSessionsController: Object.assign(
        OtherBrowserSessionsController,
        OtherBrowserSessionsController,
    ),
    CurrentUserController: Object.assign(
        CurrentUserController,
        CurrentUserController,
    ),
    TeamController: Object.assign(TeamController, TeamController),
    CurrentTeamController: Object.assign(
    ...
    OrganizationSetupController: Object.assign(
    ...
    NumberingSeriesController: Object.assign(
