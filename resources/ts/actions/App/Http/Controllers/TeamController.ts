...
export const updateMemberRole = (
    args:
        | { team: string | number; user: string | number }
        | [team: string | number, user: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'put'> => ({
...
export const cancelInvitation = (
    args:
        | { team: string | number; invitation: string | number }
        | [team: string | number, invitation: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'delete'> => ({
...
cancelInvitation.url = (
    ...
    return (
        cancelInvitation.definition.url
            .replace('{team}', parsedArgs.team.toString())
