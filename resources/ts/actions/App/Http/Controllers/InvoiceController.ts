...
convertEstimate.url = (
    ...
    return (
        convertEstimate.definition.url
            .replace('{invoice}', parsedArgs.invoice.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
const createf0d8bb0e7372996582e8da57d97dfde6 = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
createf0d8bb0e7372996582e8da57d97dfde6.url = (options?: RouteQueryOptions) => {
    return (
        createf0d8bb0e7372996582e8da57d97dfde6.definition.url +
        queryParams(options)
    );
};
 ...
 * @route '/invoices/create'
 */
createf0d8bb0e7372996582e8da57d97dfde6.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: createf0d8bb0e7372996582e8da57d97dfde6.url(options),
    method: 'get',
 ...
 * @route '/invoices/create'
 */
createf0d8bb0e7372996582e8da57d97dfde6.head = (
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: createf0d8bb0e7372996582e8da57d97dfde6.url(options),
    method: 'head',
 ...
 */
const create86952bc75e184b051d07e718195dc9e8 = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
create86952bc75e184b051d07e718195dc9e8.url = (options?: RouteQueryOptions) => {
    return (
        create86952bc75e184b051d07e718195dc9e8.definition.url +
        queryParams(options)
    );
};
 ...
 * @route '/estimates/create'
 */
create86952bc75e184b051d07e718195dc9e8.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: create86952bc75e184b051d07e718195dc9e8.url(options),
    method: 'get',
 ...
 * @route '/estimates/create'
 */
create86952bc75e184b051d07e718195dc9e8.head = (
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: create86952bc75e184b051d07e718195dc9e8.url(options),
    method: 'head',
