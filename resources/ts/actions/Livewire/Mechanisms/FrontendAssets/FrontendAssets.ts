 ...
 * @route '/livewire-c4535f02/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ['get', 'head'],
    url: '/livewire-c4535f02/livewire.js',
 ...
 * @route '/livewire-c4535f02/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ['get', 'head'],
    url: '/livewire-c4535f02/livewire.min.js.map',
} satisfies RouteDefinition<['get', 'head']>;
 ...
 * @route '/livewire-c4535f02/livewire.csp.min.js.map'
 */
export const cspMaps = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
cspMaps.definition = {
    methods: ['get', 'head'],
    url: '/livewire-c4535f02/livewire.csp.min.js.map',
} satisfies RouteDefinition<['get', 'head']>;
