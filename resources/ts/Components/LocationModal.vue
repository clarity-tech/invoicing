                    ...
                    <form @submit.prevent="submit">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select v-model="form.country" class="mt-1 block w-full rounded-md shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm" :class="fieldErrors.country ? 'border-red-300' : 'border-gray-300'" @change="validateRequired('country', 'Country')">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button type="submit" class="inline-flex w-full justify-center rounded-md bg-brand-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-brand-700 sm:ml-3 sm:w-auto disabled:opacity-50" :disabled="form.processing">
                                {{ form.processing ? 'Saving...' : ((location?.id ? 'Update' : 'Add') + ' Location') }}
                            </button>
