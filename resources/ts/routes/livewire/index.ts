 ...
 * @route '/livewire-c4535f02/upload-file'
 */
...
uploadFile.definition = {
    methods: ['post'],
    url: '/livewire-c4535f02/upload-file',
 ...
 * @route '/livewire-c4535f02/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ['get', 'head'],
    url: '/livewire-c4535f02/preview-file/{filename}',
